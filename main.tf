module "alb-ingress" {
  source                          = "git::https://github.com/cloudposse/terraform-aws-alb-ingress?ref=v0.31.0"
  name                            = var.name
...
module "alb-target-group-alarms" {
  source                                 = "git::https://github.com/cloudposse/terraform-aws-alb-target-group-cloudwatch-sns-alarms.git?ref=0.17.0"
